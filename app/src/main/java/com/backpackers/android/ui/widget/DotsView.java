...
import com.backpackers.android.util.ColorUtils;
import com.backpackers.android.util.MathUtils;
...
public class DotsView extends View {
    ...
    private void init() {
        maxDotSize = ScreenUtils.dpToPx(4);
    ...
    public void setColors(int startColor, int endColor) {
        color1 = startColor;
        color2 = ColorUtils.darkenColor(color1, 1.1f);
        color4 = endColor;
        color3 = ColorUtils.darkenColor(color4, 1.1f);
    }
}