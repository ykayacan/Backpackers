...
public class ForumTextDelegate extends AbsAdapterDelegate<ForumPost, ForumPostViewHolder> {
    ...
    public ForumTextDelegate(OnVoteActionClickListener onVoteActionClickListener,
    ...
    public int getLayoutResId() {
        if (mIsBigLayout) {
            return R.layout.item_forum_big_text;
        }
        return R.layout.item_forum_small_text2;
    }

    @Override
    public boolean isForViewType(@NonNull ForumPost item, int position) {
        return item.getMedias() == null;
    }
    ...
    @Override
    public void onBindViewHolder(ForumPost item, ForumPostViewHolder holder, int position) {
