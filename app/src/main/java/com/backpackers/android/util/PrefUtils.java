...
public class PrefUtils {
    ...
    private static PrefUtils singleton = null;

    private final SharedPreferences mPreferences;

    private PrefUtils(Builder builder) {
        mPreferences = PreferenceManager.getDefaultSharedPreferences(builder.mContext);
    }

    /**
     * The global default {@link PrefUtils} instance.
     */
    ...
    /**
     * Fluent API for creating {@link PrefUtils} instances.
     */
    private static class Builder {
        ...
        /**
         * Create the {@link PrefUtils} instance.
         */
        public PrefUtils build() {
            return new PrefUtils(this);
        }
    }
